...
//////                            .buttonStyle(.plain)
//////
//////                            NavigationLink(destination: VisitProgressView()) {
//////                                ServiceCard(icon: "stethoscope", title: "Visit Progress", color: .green)
//////                            }
//////                            .buttonStyle(.plain)
//////
...
//////}
//////
//////// MARK: - VisitProgressView (placeholder)
//////
...
////
////    var body: some View {
////        // HomeView owns its own NavigationStack.
////        // Any NavigationLink push from here will automatically hide the tab bar
////        // because the pushed view is a child of this stack, not a tab root.
////        NavigationStack {
////            ScrollView {
////                VStack(alignment: .leading, spacing: 32) {
////
...
////                            .buttonStyle(.plain)
////
////                            // Pushing DigitalClinicBookView as a child of HomeView's
////                            // NavigationStack hides the tab bar automatically — iOS
////                            // standard behaviour for pushed (non-root) destinations.
////                            NavigationLink(destination: DigitalClinicBookView()) {
////                                ServiceCard(icon: "book.closed", title: "Digital Clinic Book", color: .purple)
////                            }
////                            .buttonStyle(.plain)
...
////    var body: some View {
////        ScrollView {
////            Text("Visit Progress coming soon")
////                .font(.title3)
////                .foregroundStyle(.secondary)
////                .padding(.top, 60)
////                .frame(maxWidth: .infinity)
...
////            List {
////                Section("Today") {
////                    NotificationRow(icon: "calendar", title: "Appointment Reminder",
////                                    message: "You have an appointment tomorrow at 9:00 AM",
////                                    time: "1h ago", color: .blue)
////                    NotificationRow(icon: "checkmark.circle", title: "Check-in Successful",
////                                    message: "You've successfully checked in",
////                                    time: "3h ago", color: .green)
////                }
////                Section("Yesterday") {
////                    NotificationRow(icon: "doc.text", title: "Prescription Ready",
////                                    message: "Your prescription is ready for pickup",
////                                    time: "1d ago", color: .orange)
////                }
////            }
////            .navigationTitle("Notifications")
////            .navigationBarTitleDisplayMode(.inline)
...
//    // In a real app this would come from a shared view model / environment object.
//    private let unreadCount = 1
//
//    var body: some View {
//        NavigationStack {
//            ScrollView {
...
//            .toolbarBackground(.visible, for: .navigationBar)
//        }
//        // Profile sheet — defined in ProfileView.swift (or kept here)
//        .sheet(isPresented: $showingProfile) {
//            ProfileView()
//        }
//        // Notifications sheet — now uses the dedicated NotificationsView
...
//
//                        HStack(spacing: 12) {
//                            // Bell icon — NavigationLink push so system provides "< Back"
